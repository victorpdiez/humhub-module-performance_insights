...
<ul class="nav nav-tabs">	
	<li class="nav active"><a href="#A" data-toggle="tab" aria-expanded="true"><?= Yii::t('PerformanceInsightsModule.base', 'Page') ?></a></li>
	<li class="nav"><a href="#B" data-toggle="tab" aria-expanded="false"><?= Yii::t('PerformanceInsightsModule.base', 'Search') ?></a></li>
</ul>

<div class="alert alert-info" id="redirect-message" style="display:none;">
	<?= Yii::t('PerformanceInsightsModule.base', 'URL contain redirects.Please enter valid URL') ?>.
</div>
<div class="tab-content">
	<div class="tab-pane fade active in" id="A">
			...
			<div class="row">
				<div id="performace-result" style="display:none;">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<p id="pr-label"><b><?= Yii::t('PerformanceInsightsModule.base', 'Latest Performance Report For') ?></b></p>
						<p id="site-id"></p>
						<hr>	

						<p id="report-generated-id"><?= Yii::t('PerformanceInsightsModule.base', 'Report Generated:') ?><span id="report-generated-time"></span></p>
						<div id="page-details">
							<span><?= Yii::t('PerformanceInsightsModule.base', 'Fully Loaded Time') ?></span>
		...
		<div class="tab-pane fade" id="B">
			...
			<h5><?= Yii::t('PerformanceInsightsModule.base', 'Find Directory Search Performance') ?></h5>
			...
			<?= $form->field($performaceSearchForm, 'keyword', [
				...
				<div id="search-performance-result" style="display:none;">
					<label><?= Yii::t('PerformanceInsightsModule.base', 'Page Details') ?></label>
					<div class="page-details-group">
						<div class="page-details_cpy page-details">
							<span><?= Yii::t('PerformanceInsightsModule.base', 'Average Loaded Time') ?></span>
