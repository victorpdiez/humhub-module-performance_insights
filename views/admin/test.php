...
<div class="tab-content">
		...
		<?= $form->field($performaceTestForm, 'url', [
			...
			<div class="row">
				<div id="performace-result" style="display:none;">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding-right">			<div id="site-screenshot"></div>			
				</div>
	...
	<div class="tab-pane fade" id="B">
		...
		<h5><?php echo Yii::t('PerformanceInsightsModule.base', 'Find Search Performance') ?></h5>
